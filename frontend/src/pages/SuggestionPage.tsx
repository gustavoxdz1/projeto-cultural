  ...
  return (
    <section className="form-page">
      ...
      <form className="card-form two-columns" onSubmit={handleSubmit}>
        <label>
          Nome do local
          <input name="name" placeholder="Ex.: Centro Cultural Palácio Rio Negro" required />
          <small className="field-helper">Use o nome pelo qual o local é conhecido publicamente.</small>
        </label>

        <label>
          Categoria sugerida
          <input list="category-suggestions" name="categoryName" placeholder="Ex.: Cultura, Lazer, Esporte" required />
          <small className="field-helper">Você pode digitar livremente ou escolher uma sugestão existente.</small>
        </label>

        <label className="full-width">
          Endereço
          <input name="address" placeholder="Rua, avenida, ponto de referência ou complemento" required />
          <small className="field-helper">Quanto mais claro o endereço, mais fácil será validar e publicar.</small>
        </label>

        <label>
          Bairro
          <input name="neighborhood" placeholder="Ex.: Centro" required />
        </label>
        ...
        {message ? <p className="feedback success full-width">{message}</p> : null}
        {error ? <p className="feedback error full-width">{error}</p> : null}
